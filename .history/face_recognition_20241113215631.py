...
class FaceRecognition:
    def __init__(self, root):
        ...
        self.photoimg_top = ImageTk.PhotoImage(Image.open(r"Images/apple-logo.jpg").resize((650, 700), Image.LANCZOS))
        self.photoimg_bottom = ImageTk.PhotoImage(Image.open(r"Images/Face Recognition.jpg").resize((950, 700), Image.LANCZOS))
