...
class FaceRecognition:
    def __init__(self, root):
        ...
        b1 = Button(f_lbl_bottom, text="Face Recognition", cursor="hand2", font=("times new roman", 23, "bold"), bg="yellow", fg="red", command=self.start_face_recognition)
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, clf):
            ...
            faces = classifier.detectMultiScale(gray_image, scaleFactor=1.1, minNeighbors=10, minSize=(100, 100), flags=cv2.CASCADE_SCALE_IMAGE)
            ...
            for (x, y, w, h) in faces:
                ...
                try:
                    ...
                    if record:
                        ...
                        cv2.putText(img, "No record found", (x, y - 5), cv2.FONT_HERSHEY_COMPLEX, 0.6, (0, 0, 255), 2)
    ...
    def start_face_recognition(self):
        recognition_thread = threading.Thread(target=self.face_recog)
