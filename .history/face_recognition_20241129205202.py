...
class FaceRecognition:
    def __init__(self, root):
        ...
        # 1st image
        img_top = Image.open(r"Images\apple-logo.jpg")  # Path updated for clarity
        ...
        # 2nd image
        img_bottom = Image.open(r"Images\FaceRecognition.jpg")
    ...
    def face_recog(self):
        def draw_boundary(img, classifier, scaleFactor, minNeighbors, color, clf):
            ...
            for (x, y, w, h) in faces:
                ...
                if confidence > 77:  # Adjust confidence threshold
        ...
        # Initialize Haar cascade and LBPH recognizer
