    ...
    try:
        ...
        for image_path in image_paths:
            try:
                ...
                # Check that ID part is in the third position and is a digit
                if len(parts) >= 3 and parts[2].isdigit():
                    id = int(parts[2])  # Use parts[2] instead of parts[1]
                else:
        ...
        if not images:
            ...
            return  # Return here if there are no images loaded
